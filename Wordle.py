...
def user_input() -> str:
    ...
    if len(inp) != 5:
        print(
            f"\033[91mThe entered word '{inp}' is not of length '5', try again\n\033[0m")
        return user_input()
...
def game_logic():
    ...
    while TURNS < 5:
        ...
        if inp == WORD:
            print(
                f"\033[92mYou guessed the word {WORD} in {TURNS + 1} turns\033[0m")
            break
        ...
        print("\033[91mYour current grid state is\n\033[0m")
        print_grid()
